...
import (
	...
	models "github.com/tomato3017/tomatobot/pkg/modules/models"
)
...
func (_m *MockBotModule) Initialize(ctx context.Context, params models.InitializeParameters) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, models.InitializeParameters) error); ok {
		r0 = rf(ctx, params)
	} else {
		r0 = ret.Error(0)
	}
...
//   - ctx context.Context
//   - params models.InitializeParameters
...
func (_c *MockBotModule_Initialize_Call) Run(run func(ctx context.Context, params models.InitializeParameters)) *MockBotModule_Initialize_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(models.InitializeParameters))
	})
	return _c
}
...
func (_c *MockBotModule_Initialize_Call) RunAndReturn(run func(context.Context, models.InitializeParameters) error) *MockBotModule_Initialize_Call {
	_c.Call.Return(run)
	return _c
}
